...
enum PomodoroPhase {
  focus('Focus', AppColors.focus),
  shortBreak('Short break', AppColors.shortBreak),
  longBreak('Long break', AppColors.longBreak);

  const PomodoroPhase(this.label, this.color);
  final String label;
  final Color color;
}
