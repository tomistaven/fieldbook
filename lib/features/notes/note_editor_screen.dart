...
///
/// Saves 600 ms after the last keystroke, when leaving the screen and when
...
class _NoteEditorScreenState extends State<NoteEditorScreen>
  ...
  void initState() {
    ...
    // Resolved eagerly: saves can run after the route has been popped.
    _repo = context.read<NoteRepository>();
    _id = widget.noteId;
