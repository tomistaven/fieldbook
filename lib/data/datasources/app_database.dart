...
// Row classes are suffixed with `Row` so the domain entities can use the
// plain names (Todo, ShoppingItem, Note, Deck, Flashcard).
...
/// Title and body are stored AES-encrypted (see NoteRepositoryImpl).
...
LazyDatabase _openConnection() {
  return LazyDatabase(() async {
    ...
    final file = File(p.join(dir.path, AppConstants.databaseFile));
